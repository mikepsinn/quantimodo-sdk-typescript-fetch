...
const _1 = require("./");
function MessagesNoticesResponseFromJSON(json) {
    return MessagesNoticesResponseFromJSONTyped(json, false);
}
exports.MessagesNoticesResponseFromJSON = MessagesNoticesResponseFromJSON;
function MessagesNoticesResponseFromJSONTyped(json, ignoreDiscriminator) {
    if ((json === undefined) || (json === null)) {
        return json;
    }
    return {
        'messagesNotices': (json['messagesNotices'].map(_1.MessagesNoticeFromJSON)),
...
exports.MessagesNoticesResponseFromJSONTyped = MessagesNoticesResponseFromJSONTyped;
function MessagesNoticesResponseToJSON(value) {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
    ...
    return {
        'messagesNotices': (value.messagesNotices.map(_1.MessagesNoticeToJSON)),
...
exports.MessagesNoticesResponseToJSON = MessagesNoticesResponseToJSON;
