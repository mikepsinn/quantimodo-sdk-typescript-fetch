...
export declare function TrackingReminderNotificationPostFromJSON(json: any): TrackingReminderNotificationPost;
export declare function TrackingReminderNotificationPostFromJSONTyped(json: any, ignoreDiscriminator: boolean): TrackingReminderNotificationPost;
export declare function TrackingReminderNotificationPostToJSON(value?: TrackingReminderNotificationPost | null): any;
/**
* @export
* @enum {string}
*/
export declare enum TrackingReminderNotificationPostActionEnum {
    Skip = "skip",
    Snooze = "snooze",
    Track = "track"
}
