...
exports.NotificationsResponseFromJSON = NotificationsResponseFromJSON;
function NotificationsResponseFromJSONTyped(json, ignoreDiscriminator) {
    if ((json === undefined) || (json === null)) {
        return json;
    }
    return {
        'notifications': (json['notifications'].map(_1.NotificationFromJSON)),
...
exports.NotificationsResponseFromJSONTyped = NotificationsResponseFromJSONTyped;
function NotificationsResponseToJSON(value) {
    ...
    return {
        'notifications': (value.notifications.map(_1.NotificationToJSON)),
...
exports.NotificationsResponseToJSON = NotificationsResponseToJSON;
