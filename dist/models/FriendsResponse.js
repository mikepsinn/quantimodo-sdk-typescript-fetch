...
const _1 = require("./");
function FriendsResponseFromJSON(json) {
    return FriendsResponseFromJSONTyped(json, false);
}
exports.FriendsResponseFromJSON = FriendsResponseFromJSON;
function FriendsResponseFromJSONTyped(json, ignoreDiscriminator) {
    if ((json === undefined) || (json === null)) {
        return json;
    }
    return {
        'friends': (json['friends'].map(_1.FriendFromJSON)),
...
exports.FriendsResponseFromJSONTyped = FriendsResponseFromJSONTyped;
function FriendsResponseToJSON(value) {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
    ...
    return {
        'friends': (value.friends.map(_1.FriendToJSON)),
...
exports.FriendsResponseToJSON = FriendsResponseToJSON;
