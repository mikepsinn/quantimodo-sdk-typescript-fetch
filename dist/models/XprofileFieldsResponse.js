...
const _1 = require("./");
function XprofileFieldsResponseFromJSON(json) {
    return XprofileFieldsResponseFromJSONTyped(json, false);
}
exports.XprofileFieldsResponseFromJSON = XprofileFieldsResponseFromJSON;
function XprofileFieldsResponseFromJSONTyped(json, ignoreDiscriminator) {
    if ((json === undefined) || (json === null)) {
        return json;
    }
    return {
        'xprofileFields': (json['xprofileFields'].map(_1.XprofileFieldFromJSON)),
...
exports.XprofileFieldsResponseFromJSONTyped = XprofileFieldsResponseFromJSONTyped;
function XprofileFieldsResponseToJSON(value) {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
    ...
    return {
        'xprofileFields': (value.xprofileFields.map(_1.XprofileFieldToJSON)),
...
exports.XprofileFieldsResponseToJSON = XprofileFieldsResponseToJSON;
