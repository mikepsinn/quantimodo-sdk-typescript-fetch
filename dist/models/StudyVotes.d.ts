...
export declare function StudyVotesFromJSON(json: any): StudyVotes;
export declare function StudyVotesFromJSONTyped(json: any, ignoreDiscriminator: boolean): StudyVotes;
export declare function StudyVotesToJSON(value?: StudyVotes | null): any;
