...
export declare function ParticipantInstructionFromJSON(json: any): ParticipantInstruction;
export declare function ParticipantInstructionFromJSONTyped(json: any, ignoreDiscriminator: boolean): ParticipantInstruction;
export declare function ParticipantInstructionToJSON(value?: ParticipantInstruction | null): any;
