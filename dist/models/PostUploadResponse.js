...
const _1 = require("./");
function PostUploadResponseFromJSON(json) {
    return PostUploadResponseFromJSONTyped(json, false);
}
exports.PostUploadResponseFromJSON = PostUploadResponseFromJSON;
function PostUploadResponseFromJSONTyped(json, ignoreDiscriminator) {
...
exports.PostUploadResponseFromJSONTyped = PostUploadResponseFromJSONTyped;
function PostUploadResponseToJSON(value) {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
...
exports.PostUploadResponseToJSON = PostUploadResponseToJSON;
