...
export declare function StudyTextFromJSON(json: any): StudyText;
export declare function StudyTextFromJSONTyped(json: any, ignoreDiscriminator: boolean): StudyText;
export declare function StudyTextToJSON(value?: StudyText | null): any;
